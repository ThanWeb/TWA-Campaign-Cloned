<template>
    <div class="custom-width mx-auto">
        ...
        <ArticleHeader 
            ...
            :image-description="'Purnululu National Park'"
            :writer="'Carolyn Beasley'"
            :date="'29 June 2022'"
            :summary="'Wild, otherworldly and unspoiled; a trip to Australia’s last real outback wilderness gets so deep under the skin that you’ll never be the same, writes travel journalist Carolyn Beasley.'"
        />
        <div class="lg:flex justify-center">
            ...
            <div class="w-article flex flex-col gap-y-6 text-base font-normal text-gray-darkest">
                ...
                <ArticleSectionHeading 
                    :content="'Start in Kununurra, the Gateway to the East Kimberley'"
                />
                <p :class="paragraphClasses">
                    ...
                    accommodation well before you get here so you can experience all of the spectacular sights and sounds before another traveller takes your place.
                </p>
                <p :class="paragraphClasses">
                ...
                <ArticleImage 
                    :image="'kimberley-2@2x.jpg'"
                    :image-description="'Aerial view of Lake Argyle'"
                />
                <ArticleSectionHeading 
                    :content="'Connect to Aboriginal Culture in the East Kimberley'"
                />
                <p :class="paragraphClasses">
                    ...
                    that I took, following your guide through nearby Mirima National Park, between ancient rock formations aptly named the ‘mini-bungles’.
                </p>
                <p :class="paragraphClasses">
                ...
                <ArticleImage 
                    :image="'kimberley-3@2x.jpeg'"
                    :image-description="'Ted Carlton at Mirima National Park'"
                />
                <ArticleSectionHeading 
                    :content="'Take to Water: Lake Kununurra and an Ord River Boat Tour'"
                />
                <p :class="paragraphClasses">
                ...
                >
                    ...
                    to experience the Ord River Discoverer Cruise.
                </p>
                <ArticleImage 
                    :image="'kimberley-4@2x.jpeg'"
                    :image-description="'The Bungle Bungle Range in Purnululu National Park'"
                />
                <ArticleSectionHeading 
                    :content="'Witness the Majesty of the Bungle Bungle Range in Purnululu National Park'"
                />
                <p :class="paragraphClasses">
                ...
                <ArticleImage 
                    :image="'kimberley-5@2x.jpg'"
                    :image-description="'Echidna Chasm, the Bungle Bungle Range, Purnululu National Park'"
                />
                <ArticleSectionHeading 
                    :content="'Explore El Questro'"
                />
                <p :class="paragraphClasses">
                ...
                <ArticleSectionHeading 
                    :content="'Eating and Drinking in the East Kimberley'"
                />
                <p :class="paragraphClasses">
                ...
                <ArticleImage 
                    :image="'kimberley-6@2x.jpeg'"
                    :image-description="'The Hoochery Distillery Café, Kununurra'"
                />
                <p :class="paragraphClasses">
