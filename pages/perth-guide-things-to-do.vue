<template>
    <div>
        ...
        />
        <p class="px-4 my-6 text-base font-normal text-gray-darkest">
        ...
        />
        <h2 class="px-4 uppercase text-gray-darkest font-semibold mb-6 text-xl tracking-widest">
        ...
        <h2 class="px-4 text-gray-darkest font-semibold mb-6 text-xl">
        ...
        <p class="px-4 my-6 text-base font-normal text-gray-darkest italic">
        ...
        <h2 class="px-4 text-gray-darkest font-semibold mb-6 text-xl uppercase tracking-widest">
        ...
        <p class="px-4 my-6 text-base font-normal text-gray-darkest italic mb-10 footer-border">
            Book your 
            <a 
